...
export default function Hero() {
  return (
    <div className={`${styles.hero} fadeIn`}>
      <div>
        <h1>
          Hi, I’m <span className={styles.gradientText}>Kishan Singh</span>
        </h1>
        ...
        <p className={styles.desc}>
          I build things for the web. I’m a software engineer specializing in
        ...
        <div className={styles.cta}>
          <a href="#projects" className={styles.btn}>
            ...
            View Projects</a>
          <a href="/Kishan_Singh_Resume.pdf" className={styles.outline}
            download="Kishan_Singh_Resume.pdf"
          >
